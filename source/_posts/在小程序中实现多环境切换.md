...
// 接口base路径
export const API_URL = 'https://mnp-pre.wopuwulian.com/wechat'
// 运行环境
export const RUN_ENV = 'test-release'

// 静态图片地址
export const IMAGE_URL = 'https://wangyuanweb.top'
// 高德定位接口
export const LOCATION_API = 'https://wangyuanweb.top'
// 高德sdk秘钥
...
/*
 * @Author: wangyuan
 * @Date: 2020-08-11 10:13:45
 * @LastEditTime: 2020-08-24 10:45:31
...
// 用于生成config.js配置
const writeES6 = (path, obj, isOverflow = false) => {
...
const write = (obj, isOverflow = false) => {
  writeES6(OUTPUT, obj, isOverflow)
  writeES5(OUTPUT_WXS, obj)
}
// 渲染一个命令行文本
function heredoc(fn) {
  return (
 ...
 * @Author: wangyuan
 * @Date: 2020-08-11 10:13:45
 * @LastEditTime: 2020-08-24 10:43:37
 * @LastEditors: wangyuan
 * @Description: 开发环境配置
 */
...
module.exports = {
  API_URL: {
    title: '接口base路径',
    value: 'http://dev.wangyuanweb.top',
  },
  RUN_ENV: {
    title: '运行环境',
    value: 'develop',
 ...
 * @Author: wangyuan
 * @Date: 2020-08-11 10:13:45
 * @LastEditTime: 2020-08-21 11:48:35
 * @LastEditors: wangyuan
 * @Description: 预发228环境配置
 */
...
module.exports = {
  ...
  API_URL: {
    title: '接口base路径',
    value: 'http://test.wangyuanweb.top'
  },
 ...
 * @Author: wangyuan
 * @Date: 2020-08-11 10:13:45
 * @LastEditTime: 2020-08-21 11:45:35
 * @LastEditors: wangyuan
 * @Description: 生产环境配置
 */
...
module.exports = {
  API_URL: {
    title: '接口base路径',
    value: 'http://prod.wangyuanweb.top',
  },
  RUN_ENV: {
    title: '运行环境',
    value: 'release',
...
module.exports = {
  // 静态图片地址
  IMAGE_URL: 'https://wangyuanweb.top',
  // 高德定位接口
  LOCATION_API: 'https://wangyuanweb.top',
  // 高德sdk秘钥
