...
~~~
## 打tag
在打tag的时候先<code>build</code>然后<code>git push</code>然后<code>git tag xx</code>然后在用<code>git push origin xx</code>
~~~
# 列出所有tag
$ git tag
